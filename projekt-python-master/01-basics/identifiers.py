...
x = 0
#global = 1  nazev promenne nemuze byt nazev klicoveho slova
PI = 3.14
city = "Opava"
#hilda@sspu-opava.cz = 'Hilda Dokonalá'  nemuze se pouzivat v promennych znaky jako @, .
password2 = 'TajneHeslo'
#007agent = 'James Bond' promenne nemuzou zacinat cisel
